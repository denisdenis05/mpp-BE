...
public class DeleteMovieTests
    {
        ...
        [Test]
        public async Task AfterInvalidDeleteGetAllMovies_ShouldReturnSameMovies()
        {
            // Act: Call the method being tested
            await _movieService.DeleteMovie(new DeleteMovieDTO{Id = 5});
        ...
        [Test]
        public async Task AfterDeleteGetAllMovies_ShouldReturnAllMoviesMinusOne()
        {
            // Act: Call the method being tested
            await _movieService.DeleteMovie(new DeleteMovieDTO{Id = 1});
            var result = await _movieService.GetAllMovies();
